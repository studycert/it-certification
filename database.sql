-- ============================================
-- STUDY CERT - BANCO DE DADOS COMPLETO
-- Versão: 1.0.0
-- Data: 2025-03-20
-- ============================================
...
-- Trigger para curtidas de materiais
CREATE TRIGGER tr_atualizar_curtidas_material
    AFTER INSERT OR DELETE ON curtidas
    FOR EACH ROW
    WHEN (NEW.material_id IS NOT NULL OR OLD.material_id IS NOT NULL)
...
CREATE POLICY "Usuários podem editar seus próprios materiais" 
...
CREATE POLICY "Usuários autenticados podem inserir simulados" 
